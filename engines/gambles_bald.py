# engines/gambles_bald.py

"""
Gambles block using BALD for pairwise query selection.
"""
...
class GamblesBALDTrial:
    """Trial container for the gambles–BALD block."""
    ...
    def __init__(
        ...
        self.left_display = GamblesBALDEngine.format_gamble(left_features)
        self.right_display = GamblesBALDEngine.format_gamble(right_features)

        self.model_p_left: Optional[float] = None
        self.model_p_right: Optional[float] = None


class GamblesBALDEngine:
    """Engine for the gambles–BALD block."""

    def __init__(self, block_label: str = "gambles_bald") -> None:
        self.block_label = block_label
    ...
    def start(self) -> GamblesBALDTrial:
        if self._done:
    ...
    def next_trial(self) -> Optional[GamblesBALDTrial]:
        if self._done:
            return None
